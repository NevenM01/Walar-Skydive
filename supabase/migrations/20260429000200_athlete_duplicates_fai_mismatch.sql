-- Add a duplicates mode that is the inverse of the existing `fai` grouping:
-- - `fai` groups rows that share the SAME normalized FAI licence
-- - `fai_mismatch` groups rows that share the SAME normalized name + country_code
--   but have 2+ DISTINCT non-empty normalized FAI licences
