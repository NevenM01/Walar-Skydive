...
Usage:
    1. Create scripts/.walar_bulk_import.env (see scripts/.walar_bulk_import.env.example).
...
load_dotenv(os.path.join(os.path.dirname(__file__), '.walar_bulk_import.env'))

IMPORT_DIR = os.environ['WALAR_IMPORT_DIR']
SUPABASE_URL = os.environ['WALAR_SUPABASE_URL']
SERVICE_ROLE_KEY = os.environ['WALAR_SERVICE_ROLE_KEY']
